...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-start justify-end w-full h-full ps-5">
        ...
        <div className="flex flex-col pe-5 pb-8 items-center justify-center w-full mt-7.5 gap-2.5">
